        ...
        <div class="row justify-content-between">
            <div class="col-lg-3 col-sm-6">
                <div class="footer-widget footer-widget__about">
                    <a href="https://nofinofinance.com">
            ...
            <div class="col-lg-2 col-sm-6">
                <div class="footer-widget footer-widget__link">
                    ...
                    <ul class="list-unstyled footer-widget__link-list">
                        ...
                        <li><a href="loan-calculator.php"><i class="fa fa-arrow-right"></i>Loan Calculator</a></li>
                        <li><a href="privacy_policy.php"><i class="fa fa-arrow-right"></i>Privacy Policy</a></li>
                        <li><a href="can_refpolicy.php"><i class="fa fa-arrow-right"></i>Cancellation/Refund Policy</a></li>
                        <li><a href="terms_conditions.php"><i class="fa fa-arrow-right"></i>Terms & Conditions </a></li>
                    </ul>
                    <!-- /.list-unstyled -->
                </div>
                <!-- /.footer-widget -->
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="footer-widget footer-widget__contact">
                    ...
                    <ul class="list-unstyled footer-widget__contact-list">
                        <li>
                            <a href="mailto:support@nofinofinance.com">
                                <i class="pylon-icon-email1"></i>
                                support@nofinofinance.com
                            </a>
                        </li>
                        <li>
...
<div class="bottom-footer">
    <div class="container">
        <p>© Copyright 2023 by Nofino Rural Finance Private Limited <a href="https://nofinofinance.com">Nofino Finance</a></p>
